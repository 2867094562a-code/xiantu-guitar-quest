...
export const strumPatterns: Array<{ id: string; label: string; level: number; steps: StrumStep[]; tip: string }> = [
  ...
  { id: "syncopated-pop", label: "流行切分：下 空 下上 空上 下上", level: 3, steps: [{ direction: "down", accent: true }, { direction: "rest" }, { direction: "down" }, { direction: "up" }, { direction: "rest" }, { direction: "up" }, { direction: "down" }, { direction: "up" }], tip: "空拍仍摆手；先用闷音把每一次经过琴弦的时间练匀，再让真正的扫弦落下。" },
  { id: "reggae-up", label: "雷鬼反拍：空上 空上 空上 空上", level: 4, steps: [{ direction: "rest" }, { direction: "up", accent: true }, { direction: "rest" }, { direction: "up", accent: true }, { direction: "rest" }, { direction: "up", accent: true }, { direction: "rest" }, { direction: "up", accent: true }], tip: "正拍完全放过，只在反拍轻扫高音弦；手腕保持小幅、轻快的来回运动。" },
  { id: "drive-eighth", label: "推进型：下上 下上 下 空 下上", level: 4, steps: [{ direction: "down", accent: true }, { direction: "up" }, { direction: "down" }, { direction: "up" }, { direction: "down", accent: true }, { direction: "rest" }, { direction: "down" }, { direction: "up" }], tip: "第 1、3 拍给一点推进感；第 3 拍后的空位是呼吸，不要停住右手。" },
  { id: "dynamic-chorus", label: "副歌动态：下下 上下上 下上", level: 5, steps: [{ direction: "down", accent: true }, { direction: "down" }, { direction: "up" }, { direction: "down" }, { direction: "up" }, { direction: "down", accent: true }, { direction: "up" }, { direction: "up" }], tip: "强拍扫得更宽，弱拍只擦高音弦。先把音量层次做出来，再提高速度。" },
];
